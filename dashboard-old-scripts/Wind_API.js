  ...
  fetch("wind_API.php", {
    ...
    .then((windata) => {
      ...
      document.getElementById("gridItem2").innerHTML =
        `Wind Speed: <span class="value"><br>${windata[0]["wind_speed"].toFixed(2)} m/s</span>`;
      document.getElementById("gridItem3").innerHTML =
        `Wind Generated Energy: <span class="value"><br>${(windata[0]["energy"] / 1000).toFixed(2)} MWh</span>`;
